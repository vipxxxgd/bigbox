<?php if (!defined('THINK_PATH')) exit();?><!-- Hello gakiw~
      ...
      <div class="container">
        <div class=" margin-bottom-40">
          <div class=" sale-product">
            <h2>商品列表</h2>
            <div class="">
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "暂时没有商品" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-3">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <img src="./picture/<?php echo ($vo[imgs][0]); ?>" class="img-responsive" alt="<?php echo ($vo["name"]); ?>">
                          </div>
                          <h3><a href="./?a=goods&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a></h3>
                          <div class="pi-price"><?php echo ($vo["price"]); ?></div>
                          <a  onclick="addCar('<?php echo ($vo["id"]); ?>')" class="btn btn-default add2cart">Add to cart</a>
                        </div>
                      </div><?php endforeach; endif; else: echo "暂时没有商品" ;endif; ?>
