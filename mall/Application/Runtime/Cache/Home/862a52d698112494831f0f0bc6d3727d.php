              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    ...
                    <img src="/mall/picture/<?php echo ($imgs[0]); ?>" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="/mall/picture/<?php echo ($imgs[0]); ?>">
                  </div>
                  <div class="product-other-images">

                      <?php if(is_array($imgs)): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "暂时没有商品" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/mall/picture/<?php echo ($vo); ?>" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="/mall/picture/<?php echo ($vo); ?>"></a><?php endforeach; endif; else: echo "暂时没有商品" ;endif; ?>
                   
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1 style="color:#999;"><?php echo ($result["name"]); ?></h1>
                  ...
                  <div class="description">
                    <p style="margin:20px 0;"><?php echo ($result["introduction"]); ?></p>
                  </div>
                 
                  <div class="product-page-cart">
                    <button class="btn btn-primary" type="submit" onclick="addCar('<?php echo ($result["id"]); ?>')">Add to cart</button>
                  </div>
